...
class MyPatientAdapter(val context: Context, val data: List<Patient>): RecyclerView.Adapter<MyPatientAdapter.MyPatientViewHolder>() {
    ...
    private fun scheduleSync() {
        ...
        setConstraints(constraints).addTag("doctor_advice_update_constraints").build()
